        ...
        <el-row :gutter="100">
            <el-col :span="8">
                <el-menu
                    ...
                    <el-menu-item index="/main">众筹平台-控制面板</el-menu-item>
                </el-menu>
            </el-col>
            ...
            <el-col :span="3">
                <el-dropdown trigger="click" @command="handleCommand" >
                    <el-button type="success" icon="el-icon-user" style="float: right;margin-top:10px">{{username}}
...
export default {
    ...
    methods: {
        ...
        handleCommand(command) {
            axios.get(`http://localhost:8181/admin/${command}`).then(response =>{
    ...
    created() {
      ...
      this.username = JSON.parse(sessionStorage.getItem("admin")).userName;
    }
};
</script>